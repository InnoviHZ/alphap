  ...
  <aside class="main-sidebar sidebar-dark-primary custom-sidebar elevation-4">
    ...
    <div class="sidebar">
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="./images/admin-avatar.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form id="profileForm" enctype="multipart/form-data">
              <img src="uploads/${profileData.picture}" alt="Profile Picture" class="img-fluid rounded-circle mb-3" style="max-width: 150px;">
              <div class="form-group">
