...
<div class="navbar-header">
    <a class="navbar-brand" href="index.html">
        <!-- Logo icon -->
        <b><img src="images/logo.png" alt="homepage" class="dark-logo" style="max-height: 40px;" /></b>
        <!--End Logo icon -->
        <!-- Logo text replaced with Orphanage Care -->
        <span class="navbar-text" style="font-weight: bold; color: #000; margin-left: 10px;">Orphanage Care</span>
    </a>
</div>
<!-- End Logo -->
